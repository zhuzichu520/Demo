...
class EmojiSpan extends DynamicDrawableSpan {
    ...
    private final String mEmojiText;
    ...
    public EmojiSpan(Context context, String emojiText, int size, int textSize) {
        super(DynamicDrawableSpan.ALIGN_BASELINE);
        mContext = context;
        mEmojiText = emojiText;
...
//        return super.getSize(paint, text, start, end, fm);
    ...
    public Drawable getDrawable() {
        if (mDrawable == null) {
            try {
                mDrawable = EmojiManager.getDrawable(mContext, mEmojiText);
                if (mDrawable != null) {
                    mHeight = mSize;
