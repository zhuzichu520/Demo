...
public class RedPacketOpenedAttachment extends NimAttachment {
    ...
    public RedPacketOpenedAttachment() {
        super(NimAttachmentType.OpenedRedPacket);
    }

    public String getSendNickName(SessionTypeEnum sessionTypeEnum, String targetId) {
        if (NimUserStorage.INSTANCE.getAccount().equals(sendAccount) && NimUserStorage.INSTANCE.getAccount().equals(openAccount)) {
            return "自己";
        }
...
//            return ToolTeam.getTeamMemberDisplayNameYou(targetId, account);
//        } else if (sessionTypeEnum == SessionTypeEnum.P2P) {
//            return ToolUserInfo.getUserDisplayNameEx(account, "你");
//        } else {
            return account;
//        }
    }
