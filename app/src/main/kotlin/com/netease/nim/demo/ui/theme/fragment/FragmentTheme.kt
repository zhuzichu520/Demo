package com.netease.nim.demo.ui.theme.fragment
...
import com.netease.nim.demo.databinding.DialogFragmentThemeBinding
import com.netease.nim.demo.ui.theme.viewmodel.ViewModelTheme
import kotlinx.android.synthetic.main.dialog_fragment_theme.*

class FragmentTheme :
    BottomDialogFragmentBase<DialogFragmentThemeBinding, ViewModelTheme, ArgDefault>(),
    RadioGroup.OnCheckedChangeListener {

    override fun bindVariableId(): Int = BR.viewModel

    override fun setLayoutId(): Int = R.layout.dialog_fragment_theme
