package com.hiwitech.android.shared.widget.camera;
...
import com.hiwitech.android.shared.widget.camera.listener.ClickListener;
import com.hiwitech.android.shared.widget.camera.listener.FlowCameraListener;
import com.hiwitech.android.shared.widget.camera.listener.OnVideoPlayPrepareListener;
import com.hiwitech.android.shared.widget.camera.listener.TypeListener;
import com.hiwitech.android.shared.widget.camera.util.LogUtil;
...
public class FlowCameraView extends FrameLayout {
    ...
    public void initView() {
        ...
        mCaptureLayout.setCaptureLisenter(new CaptureListener() {
            ...
            public void takePictures() {
                ...
                //测试新版本 CameraView
                mVideoView.takePicture(photoFile = initTakePicPath(), ContextCompat.getMainExecutor(mContext), new ImageCapture.OnImageSavedCallback() {
                    @Override
    ...
    public File initTakePicPath() {
        return new File(CacheGlobal.INSTANCE.getCameraDir(), System.currentTimeMillis() + ".jpg");
    }

    public File initStartRecordingPath() {
        return new File(CacheGlobal.INSTANCE.getCameraDir(), System.currentTimeMillis() + ".mp4");
    }
